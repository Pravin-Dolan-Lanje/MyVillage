...
<head>
    ...
    <title>Siregaon Village Schemes</title>
...
$sql = "SELECT * FROM gram_panchayat_schemes ORDER BY form_name";
                        ...
                        <?php while($row = $result->fetch_assoc()): ?>
                            <tr>
                                ...
                                <td class="action-links">
                                    <a href="../forms/Schemes/download.php?id=<?= $row['id'] ?>" class="btn">Download</a>
