...
if (isset($_GET['id'])) {
    $id = $_GET['id'];
    $sql = "SELECT * FROM shopkeeper2_products WHERE id = ?";
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    // Update SQL
    $sql = "UPDATE shopkeeper2_products SET product_name=?, product_use=?, product_price=? WHERE id=?";
    $stmt = $conn->prepare($sql);
...
<div class="container">
    ...
    <div class="card p-4 shadow-sm">
        <form action="edit.php" method="POST" enctype="multipart/form-data">
            ...
            <a href="shop2add.php" class="btn btn-success">Add Product</a>
            <a href="shop2.php" class="btn btn-secondary">Cancel</a>
        </form>
    </div>
</div>
