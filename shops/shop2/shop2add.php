...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (move_uploaded_file($_FILES["product_photo"]["tmp_name"], $target_file)) {
        ...
        $sql = "INSERT INTO shopkeeper2_products (product_name, product_use, product_photo, product_price) VALUES (?, ?, ?, ?)";
...
<div class="container">
    ...
    <div class="card p-4 shadow-sm">
        <form action="shop2add.php" method="POST" enctype="multipart/form-data">
